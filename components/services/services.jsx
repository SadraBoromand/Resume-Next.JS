          ...
          <div className="row">
            ...
            >
              <div className="icon-box iconbox-blue">
                ...
                <p>
                  I backend development with Asp.net Core and Asp.net MVC and
                  Asp.net Web API
                </p>
              </div>
            </div>
            ...
            >
              <div className="icon-box iconbox-orange ">
                ...
                <p>
                  I frontend development with <br />
            ...
            >
              <div className="icon-box iconbox-pink">
                ...
                <h4>
                  <a href="">Fast Development</a>
                </h4>
                <p>I fast development project - backend and frontend</p>
              </div>
            </div>
            ...
            >
              <div className="icon-box iconbox-yellow">
                ...
                <p>
                  I use popular design pattern in self project backend and
                  frontend
                </p>
              </div>
            </div>
            ...
            >
              <div className="icon-box iconbox-red">
                ...
                <p>
                  I show demo project in employer for get accept good enouph.
                </p>
              </div>
            </div>
            ...
            >
              <div className="icon-box iconbox-teal">
                ...
                <h4>
                  <a href="">Work Microsoft Offece</a>
                </h4>
                <p>
                  I can work by production microsoft office like Word and
                  Powerpoint
                </p>
              </div>
            </div>
